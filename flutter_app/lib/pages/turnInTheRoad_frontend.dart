...
class TurnInTheRoadPage extends StatelessWidget {
  const TurnInTheRoadPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Turn in the Road (3 Point Turn)')),
      body: Padding(
        padding: const EdgeInsets.all(8.0),
        child: Row(
          children: [
            Expanded(child: _ChecklistCard(sectionTitle: 'TURN IN THE ROAD')),
          ],
        ),
      ),
    );
