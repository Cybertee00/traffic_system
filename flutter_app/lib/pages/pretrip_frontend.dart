...
class PretripInspectionPage extends StatelessWidget {
  const PretripInspectionPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Pretrip Inspection')),
      body: Padding(
        padding: const EdgeInsets.all(8.0),
        child: Row(
          children: [
            Expanded(child: _ChecklistCard(sectionTitle: 'PRETRIP INTERIOR')),
            Expanded(child: _ChecklistCard(sectionTitle: 'PRETRIP EXTERIOR')),
          ],
        ),
      ),
    );
