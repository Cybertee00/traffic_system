...
class StraightReversePage extends StatelessWidget {
  const StraightReversePage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Straight Reverse')),
      body: Padding(
        padding: const EdgeInsets.all(8.0),
        child: Row(
          children: [
            Expanded(child: _ChecklistCard(sectionTitle: 'STRAIGHT REVERSING')),
          ],
        ),
      ),
    );
